...
Mesmo mecanismo de busca do `buscar_imoveis` (ADR-0001), sobre pgvector. A diferença está no que
se faz com um resultado ruim.
...
def consultar(pergunta: str, limite: int = LIMITE, piso: float = PISO_SIMILARIDADE,
    ...
    try:
        ...
        # Embedder fora do ar (Ollama caiu, provedor sem credencial): sem vetor não há busca. Devolver
