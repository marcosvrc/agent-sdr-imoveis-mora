...
def infra(monkeypatch):
    ...
    for mod in ("agent.nodes.qualificador", "agent.nodes.consultor", "agent.nodes.agendador", "agent.nodes.followup",
                "agent.nodes.resumidor", "agent.nodes.supervisor", "agent.nodes.reativador"):
