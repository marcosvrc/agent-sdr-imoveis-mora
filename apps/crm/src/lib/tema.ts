/** Tema do CRM: claro, escuro ou o que o sistema operacional estiver usando.
 *
 *  Mesma mecânica do painel (ADR-0014) e de propósito: são dois produtos com identidade visual
 *  diferente, mas não há razão para a pessoa aprender dois jeitos de trocar o tema.
 *
...
const CHAVE = "tema-crm";   // chave própria: mesma origem em dev não pode fazer um app mandar no outro
...
/** Enquanto a escolha for "sistema", o CRM acompanha o anoitecer sem ninguém recarregar a aba. */
