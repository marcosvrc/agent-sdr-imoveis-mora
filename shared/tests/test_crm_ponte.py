...
As fixtures que sobem a API do CRM e o servidor MCP ficam em `conftest.py`, compartilhadas com os
outros testes da integração.
...
def test_crm_fora_do_ar_nao_derruba_o_turno(lead, monkeypatch, porta_livre):
